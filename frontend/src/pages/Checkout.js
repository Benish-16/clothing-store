...
const { clearCart } = useCart();
  ...
  const sendOtp = async (e) => {
    ...
    try {
      const res = await fetch("https://clothing-store-backc-p6nl.onrender.com/api/order/sendotp", {
        method: "POST",
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      ...
      const verifyRes = await fetch("https://clothing-store-backc-p6nl.onrender.com/api/order/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      const orderRes = await fetch("https://clothing-store-backc-p6nl.onrender.com/api/order/create", {
        method: "POST",
        headers: {
      ...
      if (orderData.success) {
        ...
        navigate('/confirmation');
           ...
           await fetch("https://clothing-store-backc-p6nl.onrender.com/api/order/sendemail", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "auth-token": localStorage.getItem("token"),
